            ...
            <div className="col-sm-8 col-md-6">
              <input
                ...
                {...register("Nombre", {
                  ...
                  minLength: { value: 4, message: "Nombre debe tener al menos 4 caracteres" },
                  maxLength: { value: 55, message: "Nombre debe tener como máximo 55 caracteres" },
                })}
                autoFocus
...
export default ArticulosRegistro; 